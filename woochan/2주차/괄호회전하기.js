...
/* 
  우선 문제 풀기가 편하게 들어온 문자열을 ['[',']','{'.....] 와 같은 형태로 파싱합니다.
  이후 이 배열을 계속해서 수정해가며 옳바른 괄호인지 확인하는 함수 check()에 넣어줍니다.
  check(s)는 괄호의 인덱스를 기준으로 같은 숫자가 들어오면 스택에서 pop해주는 방식으로 동작합니다. (들어올 수 있는 괄호의 종류가 3가지로 한정되어있어 가능했습니다.)
  함수 마지막에 스택에 남아있는 요소가 없다면 옳은 괄호로 판단합니다.
  옳은 괄호일경우 answer를 ++해주는 방식으로 풀 수 있었습니다.
*/
